...
swiper__WEBPACK_IMPORTED_MODULE_1__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_1__["Pagination"]]); // S L I D E R

var sliderBrand = document.querySelector('.swiper-container--brand');
var sliderType = document.querySelector('.swiper-container--type');
var sliderPrices = document.querySelector('.swiper-container--prices');
var sliderContainer = document.querySelector('.swiper-container'); // SWIPER BREND

var swiperBrand = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](sliderBrand, {
  slidesPerView: 1,
  spaceBetween: 15,
  loop: true,
  pagination: {
...
var swiperType = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](sliderType, {
  slidesPerView: 1,
  spaceBetween: 15,
  loop: true,
  pagination: {
...
window.addEventListener('resize', function () {
  if (window.matchMedia('(max-width: 767px)').matches) {
    if (swiperType.destroyed) {
      swiperType = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](sliderType, {
        slidesPerView: 1,
        spaceBetween: 15,
        loop: true,
        pagination: {
...
var swiperPrices = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"](sliderPrices, {
  slidesPerView: 1,
  spaceBetween: 15,
  loop: true,
  pagination: {
...
var textContainer = document.querySelector('.about-us__text-container');
var aboutMoreButton = document.querySelector('.about-us__more-button');
var pageNavigationLinks = document.querySelectorAll('.service__page-navigation_link');
var brandMoreButton = document.querySelector('.equipment-brand__more-button');
var brandContainer = document.querySelector('.equipment-brand__brand-list');
...
var typeContainer = document.querySelector('.swiper-wrapper--type');
var typeMoreButton = document.querySelector('.tech__more-button');
typeMoreButton.addEventListener('click', function () {
...
var closeButton = document.querySelector('.site-menu__nav-toggle-cross');
var closeFeedbackButton = document.querySelector('.feedback__button-cross');
var closeCallButton = document.querySelector('.call__button-cross');
var contactButtons = document.querySelectorAll('.contact-list__link--message');
var callButtons = document.querySelectorAll('.contact-list__link--phone');
...
callButtons.forEach(function (item) {
  item.addEventListener('click', function () {
